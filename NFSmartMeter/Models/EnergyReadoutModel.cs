...
namespace NFSmartMeter.Models
{
    public class EnergyReadoutModel
    {
        ...
        /// </summary>
        public uint ProtocolVer { get; internal set; }
